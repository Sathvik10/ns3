 ...
 */
#ifndef AODV1_RQUEUE_H
#define AODV1_RQUEUE_H
...
/**
 * \ingroup aodv1
 * \brief AODV1 route request queue
 *
 * Since AODV1 is an on demand routing we queue requests while looking for route.
 */
class RequestQueue
{
public:
