 ...
 */
#ifndef AODV1_RTABLE_H
#define AODV1_RTABLE_H
...
public:
  ...
  RoutingTableEntry (Ptr<NetDevice> dev = 0,Ipv4Address dst = Ipv4Address (), bool vSeqNo = false, uint32_t seqNo = 0,
                     ...
                     Ipv4Address nextHop = Ipv4Address (), Time lifetime = Simulator::Now (),uint16_t priority = 1 );
...
/**
 * \ingroup aodv1
 * \brief The Routing table used by AODV1 protocol
 */
class RoutingTable
{
public:
  ...
  bool UpdateEntry (RoutingTableEntry & rt) ;
  
  //void UpdatePriority ();
  //RoutingTableEntry & PriorityChange(RoutingTableEntry & rt);
  /**
