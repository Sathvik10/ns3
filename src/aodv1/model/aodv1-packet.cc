...
{
  static TypeId tid = TypeId ("ns3::aodv1::TypeHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv1")
...
{
  static TypeId tid = TypeId ("ns3::aodv1::RreqHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv1")
...
{
  static TypeId tid = TypeId ("ns3::aodv1::RrepHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv1")
...
{
  static TypeId tid = TypeId ("ns3::aodv1::RrepAckHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv1")
...
{
  static TypeId tid = TypeId ("ns3::aodv1::RerrHeader")
    .SetParent<Header> ()
    .SetGroupName ("Aodv1")
