 ...
 */
#ifndef AODV1PACKET_H
#define AODV1PACKET_H
...
enum MessageType
{
  AODV1TYPE_RREQ  = 1,   //!< AODVTYPE_RREQ
  AODV1TYPE_RREP  = 2,   //!< AODVTYPE_RREP
  AODV1TYPE_RERR  = 3,   //!< AODVTYPE_RERR
  AODV1TYPE_RREP_ACK = 4 //!< AODVTYPE_RREP_ACK
};
...
public:
   ...
   */
  TypeHeader (MessageType t = AODV1TYPE_RREQ);
