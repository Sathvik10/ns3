 ...
 */
#ifndef AODV1ROUTINGPROTOCOL_H
#define AODV1ROUTINGPROTOCOL_H

#include "aodv1-rtable.h"
#include "aodv1-rqueue.h"
#include "aodv1-packet.h"
#include "aodv1-neighbor.h"
#include "aodv1-dpd.h"
#include "ns3/node.h"
...
public:
  ...
  static const uint32_t AODV1_PORT;
  ...
  // To send the priority
  uint32_t PriorityOutput (const Ipv4Header &header);
  virtual int getChildType()
  {
        return 8;
  }
  uint8_t PriorityDestination (const Ipv4Address &dest);
  ...
  uint16_t CalculatePriority(uint16_t hop, uint16_t maxHop)
  {
     return (uint16_t) ((hop*4) /maxHop);
  }
...
private:
  ...
  void RecvAodv1 (Ptr<Socket> socket);
  /// Receive RREQ
